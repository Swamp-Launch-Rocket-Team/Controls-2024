...
class Drag
{
    ...
    struct drag_parameters
    {
        ...
        const float d = 6.14,// max diameter of rocket[in]
            L = 160,// distance from nosecone tip to bottom of aft, [in], DEPENDENT
            Sb = 2888.2,// body wetted area of airframesand nosecone[in , 2], DEPENDENT
            Cr = 13,// root chord of fin[in], DEPENDENT
            Ct = 11,// tip chord of fin[in], DEPENDENT
            t = 0.18,// thickness of fins[in];, DEPENDENT
            Xtc = 13,// distance from leading edge to max thickness[in], DEPENDENT
            ...
            L0 = 129;// distance from nosecone - body joint to end of aft[in], DEPENDENT
        const int Nf = 4;// number of fins

        // rail buttons
        const float a_railbutton1 = 96,// distance from nosecone tip to rail button 1[in], DEPENDENT
            Lp_railbutton1 = 1.26, //// length of rail button 1[in]
            A_railbutton1 = 0.317,// max cross - sectional area of rail button1[in , 2], 
            a_railbutton2 = 142,        //DEPENDENT
            Lp_railbutton2 = 1.26,
            A_railbutton2 = 0.317;

        // Fin Brackets, 4 sets total, 8 individial brackets
        const float a_bracket = 96,// distance from nosecone tip to fin brackets[in], DEPENDENT
        ...
        const float a_airbrake = 112,// distance from nosecone tip to airbrake[in], DEPENDENT
